			...
			<div className={`${styles.container} container`}>
				...
				<ul className={styles.list}>
					<li className={styles.item}>
						<div className={styles.iconWrapper}>{airWaterIcon}</div>
					...
					<li className={styles.item}>
						<div className={styles.iconWrapper}>{groundWaterIcon}</div>
					...
					<li className={styles.item}>
						<div className={styles.iconWrapper}>{waterWaterIcon}</div>
